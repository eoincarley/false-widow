...
permutation importance analysis. We further model the temporal expansion of the species in Ireland using a logistic 
growth framework \citep{Shigesada1995} to estimate the rate of range filling and identify high-suitability areas not yet colonised. 
We determine whether freely available satellite observations of artificial light and thermal environment can predict 
